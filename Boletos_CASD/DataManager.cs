...
namespace Boletos_CASD
{
	class DataManager
	{
		...
		//public bool IsDatabasesMatching (string pathToMatch)
		//{
		...
		//	if (pathToMatch.ToLower() == currentDatabasePath.ToLower())
		//	{
		//		return true;
		//	}
		//	else return false;
		...
		//		OpenDatabase(path);
		//		return folderPath;  // Se ela já existe, eu quero sobrescrever ou abortar a operação?? <<
		//	}
		...
		//	// Mount the path to the database file
		//	string path = databasePath; // "Data\\" + databaseName + "\\" + databaseName + ".db";
		...
		//public void InsertIntoCurrentDatabase(Dictionary<string, KeyValuePair<string, string>> alunosData)
		//{
		//	if (sqlite_cmd == null || sqlite_conn == null)
		//	{
		//		System.Windows.MessageBox.Show("Não há conexão com a base de dados");
		...
		//	if (alunosData == null)
		//	{
		//		System.Windows.MessageBox.Show("Ocorreu um erro com a criação da base de dados. Por favor, tente novamente");
		//		return;
		//	}

		//	Dictionary<string, KeyValuePair<string, string>>.KeyCollection keys = alunosData.Keys;
		//	Dictionary<string, KeyValuePair<string, string>>.ValueCollection values = alunosData.Values;

		//	string[] nomes = new string[keys.Count];
		//	keys.CopyTo(nomes, 0);
		//	KeyValuePair<string, string>[] email_bol = new KeyValuePair<string, string>[values.Count];
		//	values.CopyTo(email_bol, 0);

		//	List<Aluno> alunos = new List<Aluno>();
			
		//	for (int i = 0; i < nomes.Length; i++)
		//	{
		//		alunos.Add(new Aluno(i, nomes[i], email_bol[i].Key, email_bol[i].Value));
		//	}
